...
import { ImageBackground, StyleProp, ImageStyle, ImageURISource, ImageRequireSource, ImageResizeMode, ImageSourcePropType, ImageLoadEventData, ImageErrorEventData, ImageProgressEventDataIOS, NativeSyntheticEvent, View, ActivityIndicator } from 'react-native';
...
const RRBacgroundImage = ({ resizeMethod, resizeMode, source, onError, onLoad, onLoadStart, onLoadEnd, onProgress, progressiveRenderingEnabled, borderRadius, borderTopLeftRadius, borderTopRightRadius, borderBottomLeftRadius, borderBottomRightRadius, defaultSource, alt, height, width, style, children }: RNImageProps) => {
...
export default RRBacgroundImage
