...
public class NotificationSoundsModule extends ReactContextBaseJavaModule {
    ...
    public void getDefaultSound(final Promise promise) {
        try {
            Uri defautNotification = RingtoneManager.getActualDefaultRingtoneUri(this.reactContext,
                    RingtoneManager.TYPE_NOTIFICATION);
            String result = java.net.URLDecoder.decode(String.valueOf(defautNotification),
